      ...
      await response.data.forEach(async (item) => {
        if (
          ...
          if (!unique_key.includes(`${item.name}-${item.instrumenttype}`)) {
            ...
            if (item.exch_seg=="BSE" && item.instrumenttype == '' && item.expiry == '') {
              count++
